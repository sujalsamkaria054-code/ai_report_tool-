...
class AnalysisAgent:
    ...
    def run(self, payload: dict[str, Any]) -> dict[str, Any]:
        ...
        # Snapshot is intentionally compact for quick diagnostics in logs.
        logger.info(
            "Analysis summary | tables=%d readable=%d numeric_fields=%d chart_candidates=%d warnings=%d",
            summary["table_count"],
            summary["readable_table_count"],
            summary["numeric_field_count"],
            len(summary["chart_candidates"]),
